...
let yazi = params.slice(0).join(' ');
 if (yazi.length < 1) return message.reply('Bana ne Soracaksın?');
   message.channel.send(`Botun Düşünmesini Bekle! <a:yukleniyor:592779939099443230> `).then(msg => msg.delete(7000));
